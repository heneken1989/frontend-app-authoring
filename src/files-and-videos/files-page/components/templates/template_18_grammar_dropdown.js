...
<body>
    ...
    (function() {
        ...
        // Send timer.start message after template loads (template 18 - no audio, start immediately)
        function sendTimerStart() {
            try {
                if (window.parent) {
                    ...
                    console.log('✅ Sent timer.start message to parent (template 18 - after load)');
                }
            } catch (error) {
