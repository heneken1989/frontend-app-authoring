...
<body>
    ...
    <script>
        (function() {
            ...
            // Send timer.start message after template loads (template 41 - no audio, start immediately)
            function sendTimerStart() {
                try {
                    if (window.parent) {
                        ...
                        console.log('✅ Sent timer.start message to parent (template 41 - after load)');
                    }
                } catch (error) {
