export const getReadingDroplistTemplate = (questionText, correctAnswers, instructions = '文章を読んで、正しい答えを選んでください。', scriptText = '', answerContent = '', blankOptions = '') => {
...
<body>
    ...
    (function() {
        ...
        // Send timer.start message after template loads (template 59 - no audio, start immediately)
        function sendTimerStart() {
            try {
                if (window.parent) {
                    ...
                    console.log('✅ Sent timer.start message to parent (template 59 - after load)');
                }
            } catch (error) {
