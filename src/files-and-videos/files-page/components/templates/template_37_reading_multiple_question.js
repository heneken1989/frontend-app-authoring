...
<body>
    ...
    <script>
        ...
        (function() {
            ...
            // Send timer.start message after template loads (template 37 - no audio, start immediately)
            function sendTimerStart() {
                try {
                    if (window.parent) {
                        ...
                        console.log('✅ Sent timer.start message to parent (template 37 - after load)');
                    }
                } catch (error) {
